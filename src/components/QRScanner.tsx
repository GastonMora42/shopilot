              ...
              {result.success && result.ticket && (
                <div className="mb-6 text-left">
                  <div className="bg-white rounded-lg p-4 space-y-2">
                    ...
                    <p><strong>DNI:</strong> {result.ticket.dni}</p>
                    ...
                    <p><strong>QR validado:</strong> {result.ticket.qrIndex + 1} de {result.ticket.totalQRs}</p>
                    <p><strong>Estado:</strong> {result.ticket.allQRsUsed ? 'Todos los QRs usados' : 'QRs pendientes'}</p>
                    <p><strong>Hora de validación:</strong> {result.ticket.validationTime}</p>
                  </div>
                </div>
              )}
